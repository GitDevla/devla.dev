			...
			pages: [
				{
					...
					href: `https://noah.devla.dev/resume/en.pdf`,
				},
				{
					name: "Github",
				...
				},
				{
					...
					href: `https://www.linkedin.com/in/${process.env.LINKEDIN_ID}/`,
				},
			],
		},
	];
