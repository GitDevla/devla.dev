...
import CurrentlyListeningCard from "@/components/Cards/CurrentlyListeningCard";
...
export const revalidate = 432000; // 5 days. Actual revalidation is run using instrumentation.ts

export const metadata: Metadata = createMetadata({
	title: "Music",
	description:
		"Collection of my most played songs and artists on Youtube & Youtube Music.",
